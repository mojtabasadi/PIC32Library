 ...
 * Author: Sahand
 *
 * Created on May 18, 2020, 4:41 PM
 */
...
/*****************************************************************************/
#define PD_Pin LATDbits.LATD7
#define PD_Dir TRISDbits.TRISD7
#define CS_Pin LATDbits.LATD9
#define CS_Dir TRISDbits.TRISD9

#define FT_FALSE           (0)
#define FT_TRUE            (1)

class FT800: private spi,delay{
    public:   
...
#define FT800_StartTransmission() CS_Pin=0
#define FT800_StopTransmission() CS_Pin=1
...
void tr8(uint8_t value)  {spi.transfer1(value);}
